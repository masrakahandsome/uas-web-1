...
<html lang="en">
  <head>
    ...
    <title>DAFTAR PEMILIK KUCING</title>
  </head>
  <body>
...
<div class="row no-gutters mt-5 ">
  ...
  <div class="col-md-10 p-5 pt-2 ">
    <h3><i class="fas fa-cat"></i> DAFTAR PEMILIK KUCING</h3><hr>
  ...
  <thead>
    ...
    <?php
        ...
        while($kucing = mysqli_fetch_array($query)){
            ...
            echo "<td>".$kucing['nama']."</td>";
            echo "<td>".$kucing['jenis']."</td>";
            echo "<td>".$kucing['jk']."</td>";
            echo "<td>".$kucing['pemilik']."</td>";

            echo "<td>";
            echo "<a href='edit_kucing.php?id=".$kucing['nama']."'>Edit</a> | ";
            echo "<a href='hapus_kucing.php?id=".$kucing['nama']."'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
...
<a href="input_kucing.php">Tambah Data </a> 
