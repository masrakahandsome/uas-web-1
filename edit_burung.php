...
<html lang="en">
  <head>
    ...
    <title>EDIT DATA PEMILIK BURUNG</title>
  </head>
  <body>
...
<div class="row no-gutters mt-5 ">
  ...
  include "koneksi.php";
  $kd=$_GET['id'];
  $sql = "SELECT * FROM burung WHERE nama ='$kd'";
  $query = mysqli_query($conn,$sql);
  $burung = mysqli_fetch_array($query);
  ?>
  <div class="col-md-10 p-5 pt-2 ">
    <h3><i class="fas fa-dove"></i> EDIT DATA PEMILIK BURUNG</h3><hr>
    <div class="container">
  <div class="row">
    <div class="col-sm-4">
      <form action="proses_edit_burung.php" method="post" enctype="multipart/form-data" >
        <div class="form-group">
          <label>Nama</label><br>
          <input type="text" class="form-control" placeholder="Nama" name="nama" id="nama" value="<?php echo $burung['nama'] ?>">
          <label>Jenis</label><br>
          <input type="text" class="form-control" placeholder="Jenis" name="jenis" id="jenis" value="<?php echo $burung['jenis'] ?>">
          <label>Jenis Kelamin</label><br>
          <input type="text" class="form-control" placeholder="Jenis Kelamin" name="jk" id="jk" value="<?php echo 
          $burung['jk'] ?>">
          <label>Pemilik</label><br>
          <input type="text" class="form-control" placeholder="Pemilik" name="pemilik" id="pemilik" value="<?php echo $burung['pemilik'] ?>"><br>
