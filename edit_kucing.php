...
<html lang="en">
  <head>
    ...
    <title>EDIT DATA PEMILIK KUCING</title>
  </head>
  <body>
...
<div class="row no-gutters mt-5 ">
  ...
  include "koneksi.php";
  $kd=$_GET['id'];
  $sql = "SELECT * FROM kucing WHERE nama ='$kd'";
  $query = mysqli_query($conn,$sql);
  $kucing = mysqli_fetch_array($query);
  ?>
  <div class="col-md-10 p-5 pt-2 ">
    <h3><i class="fas fa-cat"></i>EDIT DATA PEMILIK KUCING</h3><hr>
    <div class="container">
  <div class="row">
    <div class="col-sm-4">
      <form action="proses_edit_kucing.php" method="post" enctype="multipart/form-data" >
        <div class="form-group">
          <label>Nama</label><br>
          <input type="text" class="form-control" placeholder="Nama" name="nama" id="nama" value="<?php echo $kucing['nama'] ?>">
          <label>Jenis</label><br>
          <input type="text" class="form-control" placeholder="Jenis" name="jenis" id="jenis" value="<?php echo $kucing['jenis'] ?>">
          <label>Jenis Kelamin</label><br>
          <input type="text" class="form-control" placeholder="Jenis Kelamin" name="jk" id="jk" value="<?php echo 
          $kucing['jk'] ?>">
          <label>Pemilik</label><br>
          <input type="text" class="form-control" placeholder="Pemilik" name="pemilik" id="pemilik" value="<?php echo $kucing['pemilik'] ?>"><br>
