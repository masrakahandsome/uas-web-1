...
<html lang="en">
  <head>
    ...
    <title>DAFTAR PEMILIK BURUNG</title>
  </head>
  <body>
...
<div class="row no-gutters mt-5 ">
  ...
  <div class="col-md-10 p-5 pt-2 ">
    <h3><i class="fas fa-dove"></i></i> DAFTAR PEMILIK BURUNG</h3><hr>
  ...
  <thead>
    <tr>
      ...
      <td scope="col">Pemilik</td>
      <td scope="col">Opsi</td>

    </tr>

    <?php
        $sql = "SELECT * FROM burung";
        $query = mysqli_query($conn, $sql);

        while($burung = mysqli_fetch_array($query)){
            echo "<tr>";

            echo "<td>".$burung['nama']."</td>";
            echo "<td>".$burung['jenis']."</td>";
            echo "<td>".$burung['jk']."</td>";
            echo "<td>".$burung['pemilik']."</td>";

            echo "<td>";
            echo "<a href='edit_burung.php?id=".$burung['nama']."'>Edit</a> | ";
            echo "<a href='hapus_burung.php?id=".$burung['nama']."'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
...
<a href="input_burung.php">Tambah Data </a> 
