...
<html lang="en">
  <head>
    ...
    <title>DAFTAR PEMILIK ANJING</title>
  </head>
  <body>
...
<div class="row no-gutters mt-5 ">
  ...
  <div class="col-md-10 p-5 pt-2 ">
    <h3><i class="fas fa-dog"></i> DAFTAR PEMILIK ANJING</h3><hr>
  ...
  <thead>
    ...
    <?php
        ...
        while($anjing = mysqli_fetch_array($query)){
            echo "<tr>";

            echo "<td>".$anjing['nama']."</td>";
            echo "<td>".$anjing['jenis']."</td>";
            echo "<td>".$anjing['jk']."</td>";
            echo "<td>".$anjing['pemilik']."</td>";

            echo "<td>";
            echo "<a href='edit_anjing.php?id=".$anjing['nama']."'>Edit</a> | ";
            echo "<a href='hapus_anjing.php?id=".$anjing['nama']."'>Hapus</a>";
            echo "</td>";
            echo "</tr>";
...
<a href="input_anjing.php">Tambah Data </a> 
